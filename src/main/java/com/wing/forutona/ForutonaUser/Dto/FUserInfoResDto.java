...
public class FUserInfoResDto {
    ...
    public FUserInfoResDto(FUserInfo fUserInfo){
        ...
        this.forutonaAgree = fUserInfo.isForutonaAgree();
        this.forutonaManagementAgree = fUserInfo.isForutonaManagementAgree();
        this.privateAgree = fUserInfo.isPrivateAgree();
        this.positionAgree = fUserInfo.isPositionAgree();
        this.martketingAgree = fUserInfo.isMartketingAgree();
        this.ageLimitAgree = fUserInfo.isAgeLimitAgree();
