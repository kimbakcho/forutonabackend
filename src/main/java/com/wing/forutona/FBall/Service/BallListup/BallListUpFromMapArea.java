...
public class BallListUpFromMapArea implements  BallListUpService{
    ...
    public Page<FBallResDto> search(Object reqDto, FSorts sort, Pageable pageable) throws Exception {
        if(!(reqDto instanceof  BallFromMapAreaReqDto)){
            throw new Exception("Not Type BallFromMapAreaReqDto");
        }
        return fBallQueryRepository.getBallListUpFromMapArea((BallFromMapAreaReqDto) reqDto,sort,pageable);
    }
}
