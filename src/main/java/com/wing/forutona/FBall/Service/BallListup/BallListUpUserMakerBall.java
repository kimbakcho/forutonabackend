...
public class BallListUpUserMakerBall implements BallListUpService {
    ...
    public Page<FBallResDto> search(Object reqDto, FSorts sort, Pageable pageable) throws Exception {
        if(!(reqDto instanceof String)){
            throw new Exception("Not Type String");
        }
        return fBallQueryRepository.getUserToMakerBalls((String)reqDto, sort, pageable);
    }
}
